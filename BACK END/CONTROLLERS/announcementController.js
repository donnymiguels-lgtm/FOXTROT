...
// GET ANNOUNCEMENTS FOR ONE ORGANIZATION

exports.getOrganizationAnnouncements =
async(req,res)=>{
...
res.status(500).json({
error:"Failed fetching organization announcements"
});
...
const role =
announcement.organization_role;
